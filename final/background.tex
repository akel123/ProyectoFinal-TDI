\section{Background}
The following definitions are necessary in order to lay the basis for how we will talk about probability vectors and stochastic matrices.
...
\definition{relative $\phi$-entropy}{
    ...
    Because $\tilde{\phi}(a,b) = \phi(a,b) + \phi(b,a)$ satisfies the conditions of Definition \ref{def2.2} if $\phi$ does, and $J_\phi(x,y) = H_{\tilde{\phi}}(x,y)$, from this point on we will speak of $J_\phi$ as $H_{\tilde{\phi}}$ 
}\label{def2.2} 
